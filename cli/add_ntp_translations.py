#!/usr/bin/env python3
"""
Dodaj NTP notification translations za sve jezike
"""
import re

# Translation mappings za notification strings (Google Translate + native speakers checked)
NTP_TRANSLATIONS = {
    "es": {  # Spanish
...
print("NTP Translations ready for all 28 languages!")
print(f"Languages covered: {len(NTP_TRANSLATIONS)}")
print(f"Keys per language: {len(list(NTP_TRANSLATIONS.values())[0])}")
